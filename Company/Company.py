...
class Firma:
    ...
    def add_leader(self, leader):
        ...
        leader.department.add_member(leader)
...
abteilungsleiter1 = Abteilungsleiter('Martha', 'Female', abteilung1)
abteilungsleiter2 = Abteilungsleiter('Michael', 'Male', abteilung2)
abteilungsleiter3 = Abteilungsleiter('Lena', 'Female', abteilung3)
...
print('Abteilung mit größter Mitarbeiterstärke:', firma.department_largest_member_count())
